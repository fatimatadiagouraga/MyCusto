...
function lzrestaurant_scripts() {
	...
	$custom_css = '
		.logo {
			padding-top: '.esc_attr($lzrestaurant_logo_top_padding).'px;
			padding-bottom: '.esc_attr($lzrestaurant_logo_bottom_padding).'px;
			padding-left: '.esc_attr($lzrestaurant_logo_left_padding).'px;
			padding-right: '.esc_attr($lzrestaurant_logo_right_padding).'px;
		}
		#feature-pro {
			padding-top: '.esc_attr($lzrestaurant_products_section_padding).'px ;
			padding-bottom: '.esc_attr($lzrestaurant_products_section_padding).'px;
		}
	';
